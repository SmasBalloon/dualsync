...
export function getFrontendAddonsChoices(frontend: string): AddonChoice[] {
    ...
    if (frontend === "reactjs" || frontend === "nextjs") {
        ...
        choices.push(
            ...
            { title: "🗄️ Pinia", value: "pinia", description: "Store officiel Vue" },
            { title: "🛠️ VueUse", value: "vue-use", description: "Utilitaires Composition API" }
        );
    }
...
export function getBackendAddonsChoices(backend: string): AddonChoice[] {
    ...
    choices.push(
        ...
        { title: "🔧 Dotenv", value: "dotenv", description: "Variables d'environnement" }
    );
